...
//pre:	La lista debe haberse inicializado con algun pokemon, sino no encontrariamos nunca nada. Ademas el nombre del pokemon no deberia superar los 30 caracteres (igual el nombre mas largo eran 17 caracteres creo) y no leeria nombre de pokemones separados por un espacio
