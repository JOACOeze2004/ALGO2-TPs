...
void CrearColaVaciaRetornaNULL(){
	Cola *cola = cola_crear();
	pa2m_afirmar(cola_esta_vacía(cola), "La cantidad de elementos en la cola es 0 si esta esta vacia");
...
void EncolarCorrectamenteDevuelveTrue(){
    ...
    size_t cantidad_luego_agregar1 = cola_cantidad(cola);
    cola_encolar(cola,&charizard);
    size_t cantidad_luego_agregar2 = cola_cantidad(cola);

	pa2m_afirmar(cantidad_luego_agregar1 == 1, "La cantidad de elementos en la cola es 1 si agrego 1 elemento correctamente");
	pa2m_afirmar(cola_encolar(cola,&pikachu), "Se puedo encolar a Picachu");
	pa2m_afirmar(cantidad_luego_agregar2 == 2, "La cantidad de elementos en la cola es 2 si agrego 1 elemento correctamente");
...
void EncolarNULLDevuelveFalse(){
    ...
    size_t cantidad_luego_agregar5 = cola_cantidad(cola);

	pa2m_afirmar(!cola_encolar(cola,NULL), "No se puedo encolar con puntero NULL");
	pa2m_afirmar(cantidad_luego_agregar5 == 1, "La cantidad de elementos en la cola sigue siendo 1 si intento agregar un elemento NULL");
...
void EncolarCorrectamenteDevuelveTrueYFrrenteCorrecto(){
	Cola *cola = cola_crear();
